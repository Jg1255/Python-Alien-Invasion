...
class Ship(GImage):
    ...
    def __init__(self,f,s,TheWIDTHS,TheHEIGHTS,sourcess):
        GImage.__init__(self,x=f,y=s,width=TheWIDTHS,height=TheHEIGHTS,\
        source=sourcess)
    ...
    def collides(self,bolt):
        ...
        if self.contains((bolt.x + BOLT_HEIGHT/2,bolt.y + BOLT_HEIGHT/2)):
            return True
        if self.contains((bolt.x - BOLT_HEIGHT/2,bolt.y + BOLT_HEIGHT/2)):
            return True
        if self.contains((bolt.x + BOLT_HEIGHT/2,bolt.y - BOLT_HEIGHT/2)):
...
class Alien(GImage):
    ...
    def __init__(self,j,f,TheWIDTH,TheHEIGHT,sources):
     GImage.__init__(self,x=j,y=f,width=TheWIDTH,height=TheHEIGHT\
     ,source=sources)
...
class Bolt(GRectangle):
    ...
    def __init__(self,s,t,TheWIDTH,TheHEIGHT,color):
     self.setVelocity(BOLT_SPEED)
     GRectangle.__init__(self,x=s,y=t,width=TheWIDTH,height=TheHEIGHT,\
     fillcolor=color)
